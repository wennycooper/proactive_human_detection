...
static float RANGE = 0.6 * 0.6;
//static float RANGE = 1.0 * 1.0;
static float CENTER_X = 1.0;
...
//      ROS_INFO("x : %f, y : %f, id : %d", x, y, id);
      float distance2 = pow(fabs(x) - CENTER_X, 2) + pow(fabs(y) - CENTER_Y, 2);
//      ROS_INFO("distance2: %f", (float) distance2);
